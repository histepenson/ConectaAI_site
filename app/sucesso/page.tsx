...
// Permite usar fbq sem erro do TypeScript
declare global {
  interface Window {
    fbq: any;
  }
...
export default function Sucesso() {
  // 🔥 Dispara o evento de conversão da Meta ao abrir a página
  useEffect(() => {
    if (typeof window.fbq !== "undefined") {
      window.fbq("track", "Purchase", {
        value: 0, // se quiser posso colocar o valor real da compra
        currency: "BRL",
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-green-100 px-4">
      <div className="bg-white border border-green-300 shadow-xl rounded-2xl p-10 max-w-lg w-full text-center">
        ...
        <p className="text-gray-700 mb-8 whitespace-normal">
          Nosso agente de IA ConectaAI já está disponível para te ajudar. Clique no botão
          abaixo para tirar todas as suas dúvidas do agro.
        </p>
